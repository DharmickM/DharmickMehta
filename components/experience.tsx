...
const experiences = [
  ...
  },
  {
    ...
    logo: "/Manawa.jpeg",
    website: "https://www.manawaenergy.co.nz/",
    description: [
  ...
  },
  {
    ...
    website: "https://www.trustpower.co.nz/",
    description: [
  ...
  },
  {
    ...
    logo: "/SS.webp",
    website: "https://specialstudio.co/",
    description: [
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-start">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h3
                        className={`text-xl font-semibold ${inter.className}`}
                      >
                        {exp.title}
                      </h3>
                      <Link
                        ...
                        className="text-muted-foreground hover:text-name-acent transition-colors duration-200 font-medium"
                      >
                        {exp.company}
                      </Link>
                    </div>
                ...
                <ul className="list-disc pl-5 space-y-2">
                  {exp.description.map((item, i) => (
                    <li
                      key={i}
                      className={`text-muted-foreground ${inter.className}`}
                    >
                      {item}
                    </li>
                  ))}
                </ul>
                <div className="flex flex-wrap gap-2 text-heading-1">
