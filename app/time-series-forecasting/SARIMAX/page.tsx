      ...
      <div className="mb-8 flex items-center justify-between">
        <div>
          ...
          <p className="text-sub-heading">
            Advanced time series analysis using SARIMAX (Seasonal AutoRegressive
      ...
      <div className="grid gap-8">
        <Card className="p-6">
          <div className="prose dark:prose-invert max-w-none">
            ...
            <p className="text-lg">
              This notebook demonstrates the implementation of SARIMAX modeling
              for time series forecasting that I used in previous work
              experience at <b>Mecca Brands</b>. I have used{" "}
              <a
              ...
              to showcase the application of this model. The model was used to
              improve sales prediction accuracy across all sales channels by
              over 90% and provide insights into incremental revenue generated
            ...
            <p>
              The model was implemented using auto_arima by PMDARIMA. It
              incorporates multiple seasonal patterns and external regressors to
            ...
            <div className="bg-muted p-4 rounded-md mt-6">
              ...
              <ul className="list-disc pl-6 space-y-2">
                ...
                <li>
                  Provided insights into revenue generated through promotional
                  activities
                </li>
